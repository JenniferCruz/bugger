...
//World.prototype.heroCollidesWithObstacles = function () {
//    var hero = this._hero;
...
World.prototype._getObstaclesOnTheLeft = function(){
    var obstaclesXs = []; // var obstaclesOnTheLeft = [];
    ...
    this._obstacles.forEach(function(obst){
        ...
        if(obstacleIsOnTheWay){
            obstaclesXs.push(obst.getPosition().x + obst.size.width); //obstaclesOnTheLeft.push(obst);
        }
    });
  return obstaclesXs;
};
